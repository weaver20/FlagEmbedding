...
# Evaluation data (separate file with same format as train_data)
# Example: {"query": "...", "pos": ["..."], "neg": ["..."]}
eval_data="\
    ../example_data/prompt_based/eval_examples.jsonl "
...
train_group_size=8
eval_group_size=21  # Number of passages per query for evaluation (1 positive + 20 negatives for nDCG@20)
...
training_args="\
    --output_dir ./test_decoder_only_base_bge-reranker-v2-gemma_with_eval \
